...
var buildDir = "./src/Cake.Http/bin/" + configuration;
var buildTestDir = "./src/Cake.Http/bin/" + configuration;
...
var solutionPath = File("./src/Cake.Http.sln");

var zipPackage = buildResultDir + "/Cake-Http-v" + semVersion + ".zip";
    ...
    .Does(() =>
{
    ...
    NuGetPush(nugetRoot + "/Cake.Http." + version + ".nupkg", new NuGetPushSettings
    {
        ApiKey = apiKey,
